  ...
  useEffect(() => {
    ...
    return (
        ...
        <div className="header__area">
            ...
            >
                <Typography className={classes.typography}>Sign in using your email.</Typography>
            ...
            >
                <Typography className={classes.typography}>Sign up using your email.</Typography>
